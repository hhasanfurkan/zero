...
app.get('/', (req, res) => {
	res.send('Uptime kodu sandığın Site kodu açıldı');
});
...
$customEmoji[adeveloper;$getVar[emojisw1]]**Geliştiricilerim:** \`$userTag[539843855567028227]\` , \`$userTag[828327187073466368]\` , \`$userTag[655981789407346718]\`
...
$description[$customEmoji[ara;$getVar[emojisw1]]**Aranan Şarkı: \`$message\`**
...
$customEmoji[ztsure2;$getVar[emojisw2]] **Şarkı uzunluğu **: __$replaceText[$replaceText[$songInfo[duration];Seconds;Saniye;-1];Second;Saniye;-1]__
